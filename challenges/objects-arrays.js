...
zooAnimals.forEach(function (bothnames) {
  animalNames.push(`Name: ${bothnames.animal_name} Scientific: ${bothnames.scientific_name}`)
...
zooAnimals.filter(function (five) {
  if (five.population < 5) {
    largerPopulation.push(five);
  }
})
...
*/
const populationTotal = zooAnimals.reduce(function totalPop (finalTotal, animal) {
  return finalTotal += animal.population;
}, 0);
